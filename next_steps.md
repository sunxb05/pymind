...
git branch -M main
git remote add origin https://github.com/sunxb05/pymind
```
...
and create a new repository named `pymind` as an empty repository, then push your commits to GitHub:
...
automatically ([here](https://github.com/sunxb05/pymind/issues?q=author%3Aapp%2Fgithub-actions)). Resolve them to complete the
